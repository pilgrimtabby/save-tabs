...
def change_fullscreen_settings():
    ...
    while not done:
        ...
        user_input = (f"{header}\n\nAutomatic fullscreen is: {current_setting.upper()}\n\n"
                      ...
                      "When on, files generated by this program will open windows in fullscreen."

                      "\n\nNOTE: This may require allowing System Events to access Accessibility "
                      "in System Settings.\n\nTo toggle this setting, press \"y\" (press enter to "
                      "exit): ").lower().strip()
...
def change_file_overwriting_settings():
    ...
    while not done:
        ...
        user_input = input(f"{header}\n\nFile overwriting is: {current_setting.upper()}\n\n"
                           ...
                           "\n\nTo toggle this setting, press \"y\" (press enter to exit): "
                           ).lower().strip()
